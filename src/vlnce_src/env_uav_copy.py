...
class AirVLNENV:
    def __init__(self, batch_size=8, 
        ...
        self.skip_scene = ["BattlefieldKitDesert","BrushifyCountryRoads","BrushifyForestPack","BrushifyUrban","Japanese_Street","London_Street","NordicHarbour","WesterTown"]
    ...
    def load_my_datasets(self):
        ...
        for merged_json in tqdm.tqdm(trajectorys_path):
            ...
            # merged_json = merged_json.replace('merged_data_obj_des_brief.json', 'merged_data.json')
            ...
            if args.name == 'qwen2_5vl' or args.name == 'qwen2_5vl_256':
