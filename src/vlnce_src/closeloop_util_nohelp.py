...
def initialize_env_eval(dataset_path, save_path, port):
    train_env = AirVLNENV(batch_size=args.batchSize, dataset_path=dataset_path, save_path=save_path, port=port)
    return train_env
