...
class CommonArguments:
    ...
    SUCCESSDISTANCE: int = field(default=10, metadata={"help": 'success distance'})
    PREDICTSUCCESSDISTANCE: int = field(default=8, metadata={"help": 'predict success distance'})

    xOy_step_size: int = field(default=5, metadata={"help": "max input instruction"})
    z_step_size: int = field(default=2, metadata={"help": 'max action sequence'})
    rotateAngle: int = field(default=15, metadata={"help": 'success distance'})
    ...
    use_target_des: bool = field(default=False)
    ...
    obj_desc_json_path: Optional[str] = field(default=None)
    target_des_path: Optional[str] = field(default=None)
